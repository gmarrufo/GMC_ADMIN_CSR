...
<h1>Delete Revitalash Customer Shipping Address</h1>
<body>
<form method="post" action="deleteShippingAddress.php">
...
if($Submit == "Submit")
{
	...
	$strSQL = "DELETE FROM tblCustomers_ShipTo where RecordID = " . $_SESSION['delete_id'] . "";
    ...
    include("../csradmin/customers.php");
}
