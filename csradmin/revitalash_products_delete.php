...
<h1>Delete Revitalash Product</h1>
<body>
<form method="post" action="revitalash_products_delete.php">
...
if($Submit == "Submit")
{
	...
	$strSQL = "UPDATE tblProducts SET IsActive = 'False' where RecordID = " . $_SESSION['delete_id'] . "";
