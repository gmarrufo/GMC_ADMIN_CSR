		...
		<div id="content">
         ...
         <?php
             ...
             if($TotalBoxCount > 100)
             {
				 ...
				 $BoxWeight = floor($TotalOrderWT/$TotalBoxCount);
				 ...
				 */
				 ...
				 if($RC1 != 0)
				 {
					 echo '<tr><td>FedEx Ground ' . ' ($' . number_format($RC1, 2, '.', '') . ')</td></tr>';
				 }
				 elseif($RC2 != 0)
				 {
					 echo '<tr><td>FedEx 2Day ' . ' ($' . number_format($RC2, 2, '.', '') . ')</td></tr>';
				 }
				 elseif($RC3 != 0)
				 {
					 echo '<tr><td>FedEx Express Saver ' . ' ($' . number_format($RC3, 2, '.', '') . ')</td></tr>';
				 }
				 elseif($RC4 != 0)
				 {
					 echo '<tr><td>FedEx Next Day Overnight ' . ' ($' . number_format($RC4, 2, '.', '') . ')</td></tr>';
				 }
				 elseif($RC5 != 0)
				 {
					 echo '<tr><td>FedEx 1 Day Freight ' . ' ($' . number_format($RC5, 2, '.', '') . ')</td></tr>';
				 }
				 elseif($RC6 != 0)
				 {
					 echo '<tr><td>FedEx 2 Day Freight ' . ' ($' . number_format($RC6, 2, '.', '') . ')</td></tr>';
				 }
				 elseif($RC7 != 0)
				 {
					 echo '<tr><td>FedEx 3 Day Freight ' . ' ($' . number_format($RC7, 2, '.', '') . ')</td></tr>';
				 }
				 elseif($RC8 != 0)
				 {
					 echo '<tr><td>FedEx International Priority ' . ' ($' . number_format($RC8, 2, '.', '') . ')</td></tr>';
				 }
				 elseif($RC9 != 0)
				 {
					 echo '<tr><td>FedEx International Economy ' . ' ($' . number_format($RC9, 2, '.', '') . ')</td></tr>';
				 }
				 elseif($RC10 != 0)
				 {
					 echo '<tr><td>FedEx International Priority Freight' . ' ($' . number_format($RC10, 2, '.', '') . ')</td></tr>';
				 }
				 elseif($RC11 != 0)
				 {
					 echo '<tr><td>FedEx International Economy Freight' . ' ($' . number_format($RC11, 2, '.', '') . ')</td></tr>';
				 }
				 elseif($RC12 != 0)
				 {
					 echo '<tr><td>FedEx International First ' . ' ($' . number_format($RC12, 2, '.', '') . ')</td></tr>';
				 }
             }
             else
             {
