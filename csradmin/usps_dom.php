...
<head>
	<title>Customer Management | Revitalash Administration | Calculate Boxes and Rates Prototype USPS (Domestic)</title>
...
<body>
	...
	<div id="wrapper">
		...
		<div id="content">
            ...
            {
                include("input_prod_qty_usps_dom.php");
            }
			elseif ($_GET['Action'] == 'NewOrder')
			{
               if (isset($_POST['cmdContinue']))
               {
                   include("calculate_usps_boxes.php");
               }
               else
               {
                   include("input_prod_qty_usps_dom.php");
