...
function setDefaults($var){
	if($var == 'shipaccount') Return '462227000';
/**
 ...
 */
	if($var == 'billaccount') Return '462227000';
	if($var == 'dutyaccount') Return '462227000';
	if($var == 'meter') Return '100677102';
	if($var == 'key') Return 'hRnybIZX3PKne28q';
	if($var == 'password') Return 'yDjVeSkK252f1kFblX1AXy31b';
