<h1>Orders Summary (Entered By)</h1>

<?php

$strOutput = "";
$strOutput .= '<p>Below is a summary of orders. To view a specific set of orders per Entered By, please click on the link by the Name below.</p>';
$strOutput .= '<p>Or by querying by Date Range:</p>';
$strOutput .= '<form action="/csradmin/orders.php" method="get">';
$strOutput .= '<input type="hidden" name="Action" value="SummarySearch">';
