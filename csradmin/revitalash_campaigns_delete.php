...
<h1>Delete Revitalash Campaign</h1>
<body>
<form method="post" action="revitalash_campaigns_delete.php">
...
if($Submit == "Submit")
{
	...
	$strSQL = "DELETE FROM tblCampaigns where RecordID = " . $_SESSION['delete_id'] . "";
