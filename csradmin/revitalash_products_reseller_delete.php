...
<h1>Delete Revitalash Product Reseller Tier</h1>
<body>
<form method="post" action="revitalash_products_reseller_delete.php">
...
if($Submit == "Submit")
{
	...
	$strSQL = "DELETE * FROM tblProducts_ResellerTier WHERE RecordID = " . $_SESSION['delete_id'] . "";
