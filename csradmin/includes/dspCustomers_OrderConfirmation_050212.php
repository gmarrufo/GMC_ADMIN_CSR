...
if (isset($_POST['ItemID1']) && $_POST['ItemID1'] != 0)
{
    ...
    {
        $strConfirmation .= '<td>' . $strProductName1 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
    ...
    {
	    $strConfirmation .= '<td style="text-align:right;">$' . number_format(($_POST['ItemPrice1'] * $_POST['ItemQty1'])*.25, 2, '.', '') . '</td>';
    }
    else
    {
	...
	if($_SESSION['MascaraEspressoBlowOut2010_1'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_1'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
	...
	{
	    $strConfirmation .= '<tr>';
	    $strConfirmation .= '<td>Pink Revitalash&reg; Bag</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['PinkBag13Free2011'] . '</td>';
        $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '</tr>';
    }
    */
...
if (isset($_POST['ItemID2']) && $_POST['ItemID2'] != 0)
{
    ...
    {
	    $strConfirmation .= '<td>' . $strProductName2 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_2'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_2'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID3']) && $_POST['ItemID3'] != 0)
{
    ...
    {
	     $strConfirmation .= '<td>' . $strProductName3 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
    ...
    if($_SESSION['MascaraEspressoBlowOut2010_3'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_3'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID4']) && $_POST['ItemID4'] != 0)
{
    ...
    {
	    $strConfirmation .= '<td>' . $strProductName4 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_4'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_4'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID5']) && $_POST['ItemID5'] != 0)
{
    ...
    {
	    $strConfirmation .= '<td>' . $strProductName5 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_5'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_5'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID6']) && $_POST['ItemID6'] != 0)
{
    ...
    {
	    $strConfirmation .= '<td>' . $strProductName6 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_6'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_6'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID7']) && $_POST['ItemID7'] != 0)
{
    ...
    {
	     $strConfirmation .= '<td>' . $strProductName7 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_7'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_7'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID8']) && $_POST['ItemID8'] != 0)
{
    ...
    {
	     $strConfirmation .= '<td>' . $strProductName8 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_8'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_8'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID9']) && $_POST['ItemID9'] != 0)
{
    ...
    {
	    $strConfirmation .= '<td>' . $strProductName9 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_9'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_9'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID10']) && $_POST['ItemID10'] != 0)
{
    ...
    {
	    $strConfirmation .= '<td>' . $strProductName10 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_10'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_10'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID11']) && $_POST['ItemID11'] != 0)
{
    ...
    {
	    $strConfirmation .= '<td>' . $strProductName11 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_11'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_11'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID12']) && $_POST['ItemID12'] != 0)
{
    ...
    {
	    $strConfirmation .= '<td>' . $strProductName12 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_12'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_12'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID13']) && $_POST['ItemID13'] != 0)
{
    ...
    {
	    $strConfirmation .= '<td>' . $strProductName13 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_13'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_13'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID14']) && $_POST['ItemID14'] != 0)
{
    ...
    {
	    $strConfirmation .= '<td>' . $strProductName14 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_14'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_14'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID15']) && $_POST['ItemID15'] != 0)
{
    ...
    {
	    $strConfirmation .= '<td>' . $strProductName15 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_15'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_15'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID16']) && $_POST['ItemID16'] != 0)
{
    ...
    {
	    $strConfirmation .= '<td>' . $strProductName16 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_16'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_16'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID17']) && $_POST['ItemID17'] != 0)
{
    ...
    {
	    $strConfirmation .= '<td>' . $strProductName17 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_17'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_17'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID18']) && $_POST['ItemID18'] != 0)
{
    ...
    {
	    $strConfirmation .= '<td>' . $strProductName18 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_18'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_18'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID19']) && $_POST['ItemID19'] != 0)
{
    ...
    {
	    $strConfirmation .= '<td>' . $strProductName19 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_19'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_19'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
if (isset($_POST['ItemID20']) && $_POST['ItemID20'] != 0)
{
    ...
    {
	    $strConfirmation .= '<td>' . $strProductName20 . '<br>Pre-Sale Special Pricing 10% off regular price + Free Shipping</td>';
    }
    else
    {
    ...
    */
	...
	if($_SESSION['MascaraEspressoBlowOut2010_20'] > 0)
	{
	    ...
	    $strConfirmation .= '<td>Mascara by RevitaLash - Espresso (Blk/Brwn)</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
        $strConfirmation .= '<td>' . $_SESSION['MascaraEspressoBlowOut2010_20'] . '</td>';
	    $strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	    $strConfirmation .= '</tr>';
	}
    */
...
{
	$strConfirmation .= '<tr>';
	$strConfirmation .= '<td>Mothers Day Gift Candle</td>';
	$strConfirmation .= '<td>$' . number_format(0, 2, '.', '') . '</td>';
	$strConfirmation .= '<td>' . $_SESSION['Revitalash_Hair_Total_Qty'] . '</td>';
...
// $strConfirmation .= '<th colspan="2" align="left">Shipping Cost:</th>';
...
if ($blnIsInternational == 0)
{
     ...
     // GMC 06/29/09 - End June Promotions
     /*
     elseif ($_SESSION['Hair_June_2009_Free_Ground_Promo'] == 'True' && $_SESSION['ShipMethodID'] == '300')
     {
        $_SESSION['OrderShipping'] = 0;
        $strConfirmation .= '<td style="text-align:right;">' . number_format($_SESSION['OrderShipping'], 2, '.', '') . '</td>';
     }
...
$strConfirmation .= '</tr>';
$strConfirmation .= '<tr>';
$strConfirmation .= '<th colspan="2" align="left">Handling Cost:</th>';
*/
/*
if ($blnIsInternational == 0)
{
     ...
     {
         $_SESSION['OrderHandling'] = 0;
         $strConfirmation .= '<td style="text-align:right;">' . number_format($_SESSION['OrderHandling'], 2, '.', '') . '</td>';
     }
